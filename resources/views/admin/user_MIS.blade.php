            ...
            <tbody>
                @foreach($data['users'] as $user)
                    <tr>
                        ...
                        @endif
                        <td>
                            <a href='#edit' id="edit_button" class='waves-effect waves-light waves-light btn-small btn-flat modal-trigger action-buttons' data-id = "{{$user->id}}"
                            data-username = "{{$user->username}}" data-name = "{{$user->name}}" data-dept = "{{$user->department_id}}"
                            data-role = "{{$user->role_id}}">
                                <i class='material-icons'>edit</i>
                            </a>
                            
                            <a href='#pass' id="change_pass_button" class='waves-effect waves-light waves-light btn-small btn-flat modal-trigger action-buttons' data-id = "{{$user->id}}"
                            data-username = "{{$user->username}}">
                                <i class='material-icons'>vpn_key</i>
                            </a>
                            
                            <a href='#disable' id="disable_button" class='waves-effect waves-light waves-light btn-small btn-flat modal-trigger action-buttons' data-id = "{{$user->id}}"
                            data-username = "{{$user->username}}" data-is_disabled = "{{$user->is_disabled}}">
